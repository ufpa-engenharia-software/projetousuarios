package br.ufpa.bdii.service.criteria;
...
/**
 * Criteria class for the {@link br.ufpa.bdii.domain.Endereco} entity. This class is used
 * in {@link br.ufpa.bdii.web.rest.EnderecoResource} to receive all the possible filtering options from
